...
def init_screens():
    return [Screen(top=bar.Bar(widgets=init_widgets_screen1(), size=26, opacity=1, border_width=[0,0,2,0])),
            Screen(top=bar.Bar(widgets=init_widgets_screen2(), size=26, opacity=1, border_width=[0,0,2,0]))]
